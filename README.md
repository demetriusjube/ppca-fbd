...
- Foram encontrados valores em que a variação entre o valor pago por por dois senadores passa de cem vezes. Alguns casos interessantes são: 
    -  "Auto Posto Nossa Senhora de Fátima II", em um pagamento, a título de "Locomoção, hospedagem, alimentação, combustíveis e lubrificantes": senador "VALDIR RAUPP" pagou R$ 6.800,00 enquanto o senador "IVO CASSOL" pagou R$ 35,03.
